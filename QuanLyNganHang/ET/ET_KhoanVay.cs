...
namespace ET
{
    ...
    {
        public ET_KhoanVay(string maVay, string maKH, string maTK, decimal soTienVay, DateTime ngayVay, DateTime thoiHan, string trangThai, string maLaiSuat, string tinhTrangXoa)
        {
            MaVay = maVay;
            MaKH = maKH;
            MaTK = maTK;
