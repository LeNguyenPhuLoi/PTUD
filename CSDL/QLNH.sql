...
CREATE TABLE PHONGBAN(MAPB INT NOT NULL,
						...
						ALTER TABLE PHONGBAN ADD TrangThai BIT DEFAULT 1;
GO
----Bang chi nhanh
CREATE TABLE CHINHANH(MACN CHAR(10) NOT NULL,
						TENCN NVARCHAR(70) NOT NULL,
...
CREATE TABLE NOIQUY(MANQ CHAR(10) NOT NULL,
					...
					ALTER TABLE NOIQUY ADD TrangThai BIT DEFAULT 1;
GO
----Bang vi pham
CREATE TABLE VIPHAM(MAVP CHAR(10) NOT NULL,
					...
					ALTER TABLE VIPHAM ADD TrangThai BIT DEFAULT 1;
GO
...
CREATE TABLE DANGNHAP(MADN CHAR(20) NOT NULL,
					...
					QUYEN NVARCHAR(50),
					MANV CHAR(10))
					ALTER TABLE DANGNHAP ADD TrangThai BIT DEFAULT 1;
...
CREATE TABLE LOAIGD (MALOAIGD VARCHAR(10) NOT NULL,
						...
						PHUONGTHUC CHAR(1) CHECK (PHUONGTHUC IN ('+', '-')),
						NGAYLAP DATETIME,
						NGAYCAPNHAT DATETIME,
						TRANGTHAI NVARCHAR(20),
						TinhTrangXoa BIT DEFAULT 0)
...
CREATE TABLE HOPDONG(MAHD INT IDENTITY(1,1) PRIMARY KEY,
						SOHOPDONG NVARCHAR(30) NOT NULL,
...
GO
ALTER TABLE GIAODICH
ADD CONSTRAINT FK_GDD_TK FOREIGN KEY(MATK)
REFERENCES TAIKHOAN(MATK)

GO
ALTER TABLE GIAODICH
ADD CONSTRAINT FK_GDN_TK FOREIGN KEY(MATKNHAN)
REFERENCES TAIKHOAN(MATK)
...
---CCCD NHAN VIEN LA DUY NHAT---
GO
ALTER TABLE NHANVIEN
ADD CONSTRAINT CCCD_NV UNIQUE(CCCD)
...
---SỐ HỢP ĐỒNG LÀ DUY NHẤT---
GO
ALTER TABLE HOPDONG
ADD CONSTRAINT SOHOPDONG_HD UNIQUE(SOHOPDONG)
