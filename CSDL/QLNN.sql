...
--BANG CHAM CONG
GO
CREATE TABLE CHAMCONG(MACONG CHAR(10) NOT NULL,
...
GO
CREATE TABLE LOAIKH(MALOAITK VARCHAR(10) NOT NULL,
							CHITIET NVARCHAR(30))
...
CREATE TABLE HOTRO(MAHTRO CHAR(10) NOT NULL,
					MAKH CHAR(10),
					LOAIHTRO NVARCHAR(50),
					NOIDUNG NVARCHAR(200),
					NGAYHTRO DATETIME)

---BẢNG HỢP ĐỒNG
GO
CREATE TABLE HOPDONG(MAHD CHAR(10) NOT NULL,
						MAKH CHAR(10),
						LOAIHD NVARCHAR(50),
						NGAYLAP DATETIME)
...
GO
--KHOA CHINH CHAM CONG
ALTER TABLE CHAMCONG
ADD CONSTRAINT PK_CC PRIMARY KEY(MACONG)
...
GO
ALTER TABLE HOTRO
ADD CONSTRAINT PK_HT PRIMARY KEY(MAHTRO)

--KHÓA CHÍNH CHO BẢNG HỢP ĐỒNG---
GO
ALTER TABLE HOPDONG
...
--CHAM CONG VS NHAN VIEN
GO
ALTER TABLE CHAMCONG
ADD CONSTRAINT FK_CC_NV FOREIGN KEY(MANV)
...
---CHUYEN KHOAN VOI LOAI KHACH HANG
GO
ALTER TABLE CHUYENKHOAN
